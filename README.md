...
1. fluorescence
2. scattering
3. reincidence of scattered photons into the sample (3D - incoherent feedback / 2D - coherent feedback)
...
To see the parameters, equations, geometry, boundary conditions, mesh and results of the fluorescence simulation **[click here](YanDRMachado/Random_Laser_COMSOL-Multiphysics/blob/main/Fluorescence Simulation Summary.pdf)**.
