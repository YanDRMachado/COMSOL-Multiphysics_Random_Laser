...
To see the parameters, equations, geometry, boundary conditions, mesh and results of the fluorescence simulation **[click here](Random_Laser_COMSOL-Multiphysics/blob/main/Fluorescence Simulation Summary.pdf)**.
